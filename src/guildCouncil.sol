...
contract GuildCouncil {
   ...
   // Returns the new gravitas of the receiver
    ...
    function highGuildMasterAcceptanceCeremony()
        external
    {
        require(msg.sender == highGuildMasterElect, "GuildCouncil::highGuildMasterAcceptanceCeremony::wrong_address");
        highGuildMaster = highGuildMasterElect;
    }
    function setHighGuildMaster(address newHighGuildMaster)
        external
        onlyHighGuildMaster
    {
        require(newHighGuildMaster != address(0), "GuildCouncil::setHighGuildMaster::wrong_address");
        HighGuildMasterElect = newHighGuildMaster;
        emit HighGuildMasterElected(newHighGuildMaster}
    }
    modifier onlyGuild() {
